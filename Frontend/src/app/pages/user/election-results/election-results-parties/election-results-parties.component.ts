...
@Component({
  selector: 'app-election-results-parties',
  templateUrl: './election-results-parties.component.html',
  styleUrls: ['./election-results-parties.component.css']
})
export class ElectionResultsPartiesComponent implements OnInit, OnDestroy {
  ...
  initElectionResultsData() {
    this.subData = this.route.data.subscribe(({ data }) => {
      ...
      for(let party of electionResultResponse.parties) {
        this.data.push({'name': party.name, 'voteCount': party.voteCount})
      }
    });   
  }
